...
min_exercised_stock_options = 999999999
max_exercised_stock_options = -99999999
...
for key, value in data_dict.items():
    ...
    if str(exercised_stock_options) != "NaN":
...
valor_atributos = np.array([[200000.0, 1000000.0]])

valor_atributos_rescaled = min_max_scaler.transform(valor_atributos)

print "salary e exercised_stock_options  rescaled:" , valor_atributos_rescaled
...
try:
    Draw(pred, finance_features, poi, mark_poi=False, name="clusters_k2.pdf", f1_name=feature_1, f2_name=feature_2)
except NameError:
