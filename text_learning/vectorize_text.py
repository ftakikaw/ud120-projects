...
print "conteudo word_data[152]:" , word_data[152]
...
palavras_vocabulario = vectorizer.get_feature_names()

print "qtd palavras diferentes: ", len(palavras_vocabulario)

print "palavra 34597 no vocabulario:", palavras_vocabulario[34597]
